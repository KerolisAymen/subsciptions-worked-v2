  ...
  translations: {
    ar: {
      ...
      landing: {
        ...
        subtitle: 'طريقة بسيطة لإدارة نفقات الرحلات وتتبع المدفوعات من المشاركين. نظم رحلاتك، وأشرك المحصلين، وتابع من دفع.',
        getStarted: 'ابدأ الآن',
        login: 'تسجيل الدخول',
        features: {
          manage: 'إدارة المشاركين',
          manageDesc: 'إضافة وإدارة المشاركين في الرحلة بسهولة، تحديد المبالغ المتوقعة، وتتبع المدفوعات.',
          track: 'تتبع المدفوعات',
          trackDesc: 'تسجيل مدفوعات المشاركين، تعيين المحصلين، والاحتفاظ بسجل كامل للمدفوعات.',
          reports: 'توليد التقارير',
          reportsDesc: 'الحصول على تقارير مفصلة عن تقدم التحصيل والأرصدة المتبقية وملخصات المحصلين.'
        }
      },
